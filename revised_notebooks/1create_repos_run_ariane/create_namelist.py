def namelist(directory, n, tl, lmt = None):
    ...
    edit = {"dir": directory, "lmt": n*24, "output": 3*24*tl-1, "input_digits": input_digits, "ind0": ind0, "indn": indn }
    if lmt != None:
        edit = {"dir": directory, "length": n, "lmt": lmt, "output": tl*24*3, "input_digits": input_digits, "ind0": ind0, "indn": indn }
    txt = """&ARIANE
