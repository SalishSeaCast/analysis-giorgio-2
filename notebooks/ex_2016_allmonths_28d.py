...
if __name__ == "__main__":
    for month in range (1,13):
        ...
        if month == 12:
            ...
            runlength (first_day = {"year": 2016, "month": month, "day": 1}, last_day = {"year": 2017, "month": 1, "day": 1}, trajlength = 12 - month)
            
        else:
            runlength (first_day = {"year": 2016, "month": month, "day": 1}, last_day = {"year": 2016, "month": month + 1, "day": 1}, trajlength = 13 - month)
